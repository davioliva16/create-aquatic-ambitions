...
public class CAARecipeProvider extends RecipeProvider {
    ...
    public CAARecipeProvider(PackOutput output) {super(output);}
    ...
    public static void registerAllProcessing(DataGenerator gen, PackOutput output) {
        GENERATORS.add(new CAACrushingRecipeGen(output, CreateAquaticAmbitions.MODID));
        GENERATORS.add(new CAAMillingRecipeGen(output, CreateAquaticAmbitions.MODID));
        GENERATORS.add(new CAAWashingDataGen(output, CreateAquaticAmbitions.MODID));
        GENERATORS.add(new CAACompactingRecipeGen(output, CreateAquaticAmbitions.MODID));
        GENERATORS.add(new CAAMixingRecipeGen(output, CreateAquaticAmbitions.MODID));
        GENERATORS.add(new CAAChannelingRecipeGen(output, CreateAquaticAmbitions.MODID));
