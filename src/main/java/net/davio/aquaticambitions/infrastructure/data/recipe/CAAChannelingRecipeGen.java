...
public class CAAChannelingRecipeGen extends ChannelingRecipeGen {
    ...
    UA_PRISMARINE_CORAL_BLOCK = moddedConversion(Mods.UA, "dead_prismarine_coral_block","prismarine_coral_block"),
    UA_ROCK_CORAL_BLOCK = moddedConversion(Mods.UA, "dead_rock_coral_block","rock_coral_block"),
    UA_SILK_CORAL_BLOCK = moddedConversion(Mods.UA, "dead_silk_coral_block","silk_coral_block"),
    UA_STAR_CORAL_BLOCK = moddedConversion(Mods.UA, "dead_star_coral_block","star_coral_block"),
    ...
    UA_PRISMARINE_CORAL = moddedCoralRevival(Mods.UA, "prismarine_coral"),
    ...
    UA_PRISMARINE_CORAL_FAN = moddedCoralRevival(Mods.UA, "prismarine_coral_fan"),
